# Generated by Django 5.1.5 on 2025-02-14 10:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=main.games.models.generate_unique_code, help_text='A unique 6-character game code for players to join.', max_length=6, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text="The player's display name.", max_length=50)),
